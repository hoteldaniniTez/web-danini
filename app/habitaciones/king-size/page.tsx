...
const habitacionData: HabitacionProps = {
  ...
  informacion:
    "Experimenta la máxima expresión del confort en nuestra espaciosa habitación con cama King Size. Aquí, el lujo se redefine a través de los detalles: una fusión perfecta entre diseño contemporáneo y toques artesanales que otorgan una personalidad única al espacio. Equipada con amenidades premium para consentir tus sentidos, esta habitación te ofrece un descanso reparador y una vista espectacular que se convierte en el telón de fondo de tu estancia. Un refugio exclusivo donde la tradición y la sofisticación se encuentran.",
  imgs: [
